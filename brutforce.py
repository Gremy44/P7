...
class BruteForce:
    ...
    def brut_force(self, wallet, elements, action_selection=[]):
        ...
        if elements:
            ...
            # rest1 and rest2 solution actuelle et la precedente
            ...
            # move aside following situation
            if rest2 == None and rest1 != None:
                return rest1

            if rest1 == None and rest2 != None:
                return rest2
            ...
            benefices = sum([action_selection[i][2] for i in range(len(action_selection))])
